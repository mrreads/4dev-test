            ...
            <div className="w-[500px] bg-white rounded-lg shadow dark:border md:mt-0 sm:w-full xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="p-8 space-y-6 md:space-y-4 sm:p-6">
                    <div className='flex col justify-between'>
                        <h1 className="heading uppercase">{ task?.title }</h1>
                    ...
                    <form method='POST' className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <input type="text" name="title" className="input-primary cursor-not-allowed opacity-70" value={task.author_name} placeholder="Исполнитель" disabled required />
                        </div>
                        <div className="pb-4">
                            <p className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Описание задачи</p>
                            <textarea name="description" value={task.description} placeholder="Введите описание задачи" required disabled className="cursor-not-allowed opacity-70 max-h-24 min-h-[70px] block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"> </textarea>
                        </div>
                        <div>
                            <p className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Состояние</p>
                            <select defaultValue={task.status} name="status" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select defaultValue={task.priority} name="priority" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
